...
async def evaluate(graph_pred: GraphRAG, graph_gold: GraphRAG):
    ...
    for q in QUESTIONS:
        # Role-playing prefix to cast the model as a historian/expert
        prompt = (
            "You are a Hogwarts historian and literary scholar, an expert in magical biographies. "
...
async def main():
    ...
    print("=== Comparing ./cache → ./cache2 with Role-Playing Attack ===\n")
